...
QT_MOC_LITERAL(1, 15, 14), // "applyParameter"
...
QT_MOC_LITERAL(8, 108, 11) // "showSetting"

    },
    "SettingsDialog\0applyParameter\0\0"
    "showPortInfo\0idx\0apply\0checkCustomBaudRatePolicy\0"
    "checkCustomDevicePathPolicy\0showSetting"
};
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsDialog::applyParameter)) {
                *result = 0;
                return;
            }
        }
