...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/iconeWindows/icone/antenne-satellite.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        MainWindow->setWindowIcon(icon);
        actionConnect = new QAction(MainWindow);
        actionConnect->setObjectName("actionConnect");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/iconeSerial/icone/usb.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionConnect->setIcon(icon1);
        actionDisconnect = new QAction(MainWindow);
        actionDisconnect->setObjectName("actionDisconnect");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/iconeSerial/icone/disconnect.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDisconnect->setIcon(icon2);
        actionQuit = new QAction(MainWindow);
        actionQuit->setObjectName("actionQuit");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/iconeWindows/icone/remove.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionQuit->setIcon(icon3);
        actionConfigure = new QAction(MainWindow);
        actionConfigure->setObjectName("actionConfigure");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/iconeSerial/icone/settings.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionConfigure->setIcon(icon4);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName("actionAbout");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/iconeWindows/icone/question.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionAbout->setIcon(icon5);
        actionAbout_Qt = new QAction(MainWindow);
        actionAbout_Qt->setObjectName("actionAbout_Qt");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/iconeWindows/icone/Qt_logo_2016.svg.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
